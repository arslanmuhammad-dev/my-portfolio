...
export const experiences = [
  ...
  },
  {
    ...
    color: "#10b981",
    highlights: [
      "Served as a full-stack engineer across React frontends and Node.js backends, translating client requirements into reliable product features.",
      ...
      "Owned feature delivery from implementation through QA support, production fixes, and release coordination with cross-functional teams.",
